...
public class NotificationController {
    ...
    public SseEmitter subscribe(@PathVariable Long userId,
        ...
        log.info("[알림 controller] SSE 구독 요청, 유저 ID: {}", userId);
    ...
    public ResponseEntity<List<NotificationResponse>> getNotifications(
        ...
        log.info("[알림 controller] 알림 내역 조회 성공 - userId: {}, lastId: {}, lastIsRead: {}, 조회된 개수: {}", userId, lastId, lastIsRead,notifications.size());
    ...
    public ResponseEntity<Long> getUnreadNotificationCount(@PathVariable Long userId) {
        ...
        log.info("[알림 controller] 미확인 알림 개수 조회 성공 : 유저 ID: {}, 미확인 알림 총 {}개 ", userId,notificationCount);
